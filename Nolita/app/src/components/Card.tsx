...
type CardProps = CardInfo & { svgPath: string };
      ...
      <div className="bg-gradient-to-br from-slate-300 to-slate-300 via-slate-400 w-full h-full  flex flex-col items-center gap-1">
        ...
        <div className="flex flex-col items-center w-full h-full px-3">
          <div className="flex flex-col justify-between h-full">
             ...
             */}
            <div>
              <div className="border-4 border-slate-600 bg-gradient-to-br from-yellow-500 to-yellow-500 via-yellow-100 p-1 text-[10px]">
                <b>Summary:</b> {summary.slice(0, 220) + ((summary.length > 220) ? "..." : "")}
              </div>
            ...
            <div className="flex justify-between text-[8px] border-t border-slate-900">
              <p className="text-gray-700">
                <b>Known for:</b> {topics.slice(0, 3).join(", ")}
              </p>
              <p className="text-gray-700">
