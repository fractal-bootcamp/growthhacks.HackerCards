      ...
      <div className="bg-slate-400 w-full h-full  flex flex-col items-center">
        <div className="flex flex-col items-center w-full p-5">
          <div className="flex justify-between w-full items-end">
            ...
            <p className="text-gray-700 text-base">{hp} HP</p>
          </div>
          <div className="bg-gradient-to-br from-yellow-400 via-yellow-700 to-yellow-400 p-2 w-full aspect-[4/3] object-cover overflow-hidden relative ">
            <img
